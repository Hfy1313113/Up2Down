...
- 🎨 **三阶段分部位绘制 · 明确区域指导**  
  腿部 ➔ 头部 ➔ 屁股，每个部位限时 50 秒。画布提供清晰范围框指引，明确躯干无需玩家绘制（由系统根据关节自动生成）。
- 🎂 **震撼的「小马诞生仪式」**  
  画作完成后，镜头推向聚光灯舞台。你的小马 3D 旋转放大登场，彩带与庆祝音效齐飞，支持鼠标/手指拖拽 360° 细细端详。
- 🏇 **骑手形象与连击挥鞭加速（含第二人称颠飞特写）**  
  马背上坐有专属人类骑手！竞速时快速连点屏幕或敲击空格，骑手将疯狂挥动马鞭抽打马屁股，激发出强劲的冲刺加速增益（最高 +60%）。但请注意节制：若马儿加速持续逼近或维持在加速上限，全屏边缘将发出快闪红色呼吸氛围灯警告并提示“差不多得了，别太颠了！”；若连续超载超过 3 秒，骑手将被马儿直接颠飞甩下马背，导致该玩家本局游戏失败！出局瞬间更会无缝切入**第二人称战马回眸视角**与**四肢大风车站神螺旋升天**的极具抽象喜剧感特写！
- 📱 **全终端响应式布局 · Tailwind CSS 构建**  
  完整前端基于 Tailwind CSS 现代化响应式框架构建，全面适配手机端、平板端与电脑端，无论横竖屏均具备弹性防挤压与自适应排版，坚决避免元素堆叠、挤压与交互遮挡。
- 💥 **魔性物理大乱斗**  
  支持马匹之间的硬核碰撞物理：并排冲撞弹飞、交错绊腿硬直、侧后方美式截停打转，以及高速追尾直接将前车“创飞”升天！
- 📐 **几何决定速度 · 双关节运动学**  
  算法精确解析出「髋关节 + 膝关节」连杆结构。腿长、大腿/小腿比例（约 1.05:1 最优）、笔画质量综合计算速度，步态严格物理正解。
- 🎥 **双重视角随心切换 · 支持自由环视**  
  比赛全程支持 **第三人称上帝视角**（镜头始终聚焦自身战马）与 **第一人称马儿视角**（支持拖拽转头环视四周对手与激烈对抗）。
- 🎉 **终点冲线礼花筒庆典**  
  第一名赛马撞线瞬间，跑道终点大门两侧礼花筒震撼鸣放，漫天彩带飞舞！
- ⚡ **零安装 · 极速 P2P 直连**  
...
| 场景 | 操作按键 / 手势 | 说明 |
| :--- | :--- | :--- |
| **画布绘制** | 鼠标左键拖拽 / 触屏滑动 | 画出部位线条（按区域提示绘制，躯干自动生成无需绘制） |
| **画布撤销/清空** | 界面按钮 | 撤销上一笔或清空重画 |
| **诞生仪式舞台** | 鼠标拖拽 / 触屏拖动 | 360° 旋转观察小马全身细节 |
| **连点冲刺加速** | **鼠标/触屏连续点击屏幕 或 敲击空格键** | 激发骑手挥鞭抽屁股加速（同时支持触屏点击与键盘空格双重交互，最高 +60%）。持续维持上限会有红光呼吸灯警告与“差不多得了别太颠了”提示，超 3 秒会被颠飞下马出局！ |
| **第一人称转头** | **按住鼠标/手指在屏幕上拖拽** | 在第一人称视角下自由左右转头查看周围对手 |
| **比赛视角切换** | **键盘 `V` 键** 或 点击右上角切换按钮 | 在「上帝旁观视角（追踪自身）」与「第一人称视角」之间无缝切换 |
